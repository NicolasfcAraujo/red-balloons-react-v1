const Game = ({id, image, alt, name, url}) => {
    return (
        <article key={id} className='gameArticle' style={window.innerWidth > 800 ? {width: "400px"} : {width: "280px"}}>
            <a href={url} style={{display: "grid", gridTemplateColumns: "1fr", justifyItems: 'center', textDecoration: 'none'}}>
                <h2 style={{fontFamily: 'Golos Text', paddingBottom: "10px", color: "#f5f5f5"}}>
                    {name}
                </h2>
